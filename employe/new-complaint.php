...
<head>
	...
	<link rel="stylesheet" href="css/complaint-emp.css">
    <!-- Favicon icon -->
        ...
        ***********************************-->
		<div class="nav-header">
			<a href="index.php" class="brand-logo">
                ...
                <img class="brand-title" src="./images/tect.png"  style="width: 255px;  height: 100px;" alt="Tectignis IT Solutions">
            </a>
        ...
        ***********************************-->
        <div class="content-body">
			...
			<div class="container-fluid">
				...
				<div class="mnj">
				Complaint Date & Time :<input type="date" placeholder="Complaint Date"><input type="time" placeholder="Date"><br>
                Complaint Type :
				<div class="mkj"><select class="jkl default-select">
				<option value="Desktop" selected>Desktop</option>
			    <option value="Laptop">Laptop</option>
			     <option value="CCTV">CCTV</option> 
                <option value="Routers">Routers</option></select></div><br>
				
				<p class="wwe">Description :</p><textarea class="www" placeholder="Write here..."></textarea><br>
				Contact Name :<input type="text" placeholder="Name"><br>
				Contact No :<input type="number" placeholder="0123-456-789"><br>
				<input type="submit">
			</div>
			</div>
        </div>
