...
<head>
    ...
    <title>Tectignis-AMC Sales Emp</title>
    <!-- Favicon icon -->
											...
											<tr>
												...
												<td>
													<div class="bt3" style="width: 300px;">
														<label class="asd" style="padding: 3px 0px;" type="button" > <i class="bi bi-cash dfg"></i></label>
														<label class="asd" style="padding: 3px 0px;" type="button" > <i class="bi bi-file-pdf dfg"></i></label>
