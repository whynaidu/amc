    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <div class="content-body">
                          ...
                          <div class="row">
                              <div class="col-md-6">
                                ...
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                      <select id="inputPassword6" class="srvc-drpdwn" aria-describedby="passwordHelpInline">
                                          <option>asdfghfds</option>
                                          <option>asdfghfds</option>
                                          <option>asdfghfds</option>
                                          <option>asdfghfds</option>
                                          </select>
            ...
            <div class="row g-3 align-items-center">
              <div class="col-md-2">
                <label for="inputPassword6" class="col-form-label">Date Of Visit</label>
              </div>
              <div class="col-md-6">
                <input type="text" id="inputPassword1" class="form-control" aria-describedby="passwordHelpInline">
              </div>
              <div class="col-6">
            ...
            <div class="row g-3 align-items-center">
              <div class="col-md-2">
                <label for="inputPassword6" class="col-form-label">Engineer Name</label>
              </div>
              <div class="col-md-6">
                <input type="text" id="inputPassword2" class="form-control" aria-describedby="passwordHelpInline">
              </div>
              <div class="col-6">
            ...
            <div class="row g-3 align-items-center">
              ...
              <div class="col-md-2">
                <textarea cols="80" rows="4" id="inputPassword3" class="srvc-dcrp" aria-describedby=""></textarea>
              </div>
              <div class="col-6">
            ...
            <!-- <button type="submit" class="btn btn-primary col-4" style="width: 90px;height: 54px;padding: 15px 4px;">Save User</button>
            <button type="submit" class="btn btn-danger col-3"  style="width: 156px;font-size: 16px;height: 53px;padding: 2px 0px;">Change Password</button> -->
            
            </div>
                              <div class="col-md-6" style="height: 150px;">
            <div class="row g-3 align-items-center">
              <div class="col-md-2" style="padding-left: 63px;">
                <label for="inputPassword6" class="col-form-label">Date</label>
              </div>
              <div class="col-md-6">
                <input type="text" id="inputPassword4" class="form-control" aria-describedby="passwordHelpInline">
              </div>
              <div class="col-6">
            ...
            <div class="row g-3 align-items-center">
              ...
              <div class="col-md-6">
                <select id="inputPassword5" class="srvc-drpdwn" aria-describedby="passwordHelpInline">
              ...
              <div class="col-6">
                <span id="passwordHelpInline5" class="form-text">
                </span>
              </div>
            </div>
            <!-- <div class="row g-3 align-items-center">
            ...
            <br/>
            <div class="tyui">
                <button type="submit" class="btn btn-primary col-4 kk" style="width: 159px;height: 44px;padding: 11px 4px;">Save New Client</button>
                <!-- <button type="submit" class="btn btn-danger col-3"  style="width: 156px;font-size: 16px;height: 53px;padding: 2px 0px;">Change Password</button>	 -->
