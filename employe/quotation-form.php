...
<head>
    ...
    <title>Tectignis-AMC Quotation-Form Emp</title>
    <!-- Favicon icon -->
    ...
    ***********************************-->
    <div id="main-wrapper">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form>
                                        <div class="row">
                                            <div class="col-sm-5">
                                        <input type="text" class="form-control" placeholder="Name" list="browsers" name="browser" id="browser" for="browsers" >
                                        <label for="browser"></label>
                                        <datalist id="browsers" class="vb">
                                        <option value="Edge">
                                        ...
                                        <option value="Safari">
                                            ...
                                            <br>
                                            <div class="col-sm-5 mt-2 mt-sm-0 my-4">
                                        ...
                                        <div class="qw my-5" style="width: 100%; border-radius: 5px;">
                                        <button type="button" class="btn btn-primary kl">Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © 2020 | Designed &amp; Developed by <a href="https://tectignis.in/" target="_blank">Tectignis IT Solutions</a> </p>            </div>
        </div>
        <!--**********************************
            Footer end
        ***********************************-->
