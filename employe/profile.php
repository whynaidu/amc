...
<button type="submit" class="profile-btn col-4" style="width: 94px;height: 43px;padding: 8px 4px;">Save User</button>
<button type="submit" class="profile-btn  col-3"  style="width: 160px;font-size: 16px;height: 44px;padding: 2px 0px;">Change Password</button>
