...
<head>
    ...
    <title>Tectignis-AMC Add New Quotation Emp</title>
    <!-- Favicon icon -->
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="row g-3 align-items-center ">
                        <div class="col-3 mx-4">
                          <label for="inputPassword6" class="col-form-label">Quotation Date</label>
                        </div>
                        <div class="col-3 text-center">
					
                          <input type="text" id="inputPassword1" class="form-control" aria-describedby="passwordHelpInline" style="width: 180px;">
                        </div>
                      
                      </div>
                    <div class="row g-4 align-items-center" >
                        <div class="col-4">
                          <label for="inputPassword6" class="col-form-label">Warehouse</label>
                        </div>
                        <div class="col-4">
                          <input type="text" id="inputPassword2" class="form-control" aria-describedby="passwordHelpInline" style="width: 180px;">
                        </div>
                      
                      </div>
                    <div class="row g-4 align-items-center"  style="padding-left: 48px;">
                        <div class="col-4 mx-2 ">
                          <label for="inputPassword3" class="col-form-label">Customer</label>
                        </div>
                        <div class="col-3">
                          <input type="text" id="inputPassword6" class="form-control" aria-describedby="passwordHelpInline" style="width: 180px;">
                        </div>
				...
				<div class="row">
					...
					<li class="nav-item search searchbarwdt">
                                    ...
                                    <table id="example2" class="table card-table display dataTablesCard">
										...
										<tbody>
											<tr>
												<td>wertyuyt</td>
												<td>2</td>
												<td><span class="text-nowrap">122/-</span></td>
												<td>10%</td>
												<td>20/-
											...
											<!-- <tr>
												...
												<!-- <td>
													<div class="bt2">
														<button type="button" class="btn btn-primary kl" style="
														height: 41px; width: 87px;"><i class="bi bi-eye ccc"></i>  View</button>
														<button type="button" class="btn btn-secondary kl gh"  style="
														width: 99px;"><i class="bi bi-pencil ccc"></i>  Edit</button>
														<button type="button" class="btn btn-success kl hj"  style="
														width: 128px;
														padding: 12px;"><i class="bi bi-arrow-left-right ccc"></i>  Convert To Sales</button>
													  </div>
												</td> -->
												<!-- <td>4 Pcs</td>
												<td>567k left</td>
					...
					<div class="col-xl-12">
						<div class="tab-content">
							<div id="Alll" class="tab-pane active fade show">
								<div class="table-responsive">
                                    <table id="example3" class="table card-table display dataTablesCard">
										<thead>
                                            <tr>
...
<!--											</tr>-->
											<tr>
												<td class="ggg">TOTAL DISCOUNT</td>
												<td class="ggg">-0.00</td>
												<!-- <td>04/08/2020<br>12:34 AM</td> -->
												<!-- <td>9876368576</td>
												<td>maheshniwate10@gmail.com</td>
												<td>Desktop -->
											...
											<tr>
												<td class="ggg">TOTAL TAXABLE VALUE</td>
												<td class="ggg">+0.00</td>
												<!-- <td>04/08/2020<br>12:34 AM</td> -->
												<!-- <td>9876368576</td>
												<td>maheshniwate10@gmail.com</td>
