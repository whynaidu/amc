  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control" id="exampleInputPassword1">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn bt">Save Purchase</button>
      </div>
    </div>
  </div>
</div>
    ...
    width: 300px;   margin-left: -21px;
">

														<a href="javascript:void(0)" class="btn bt" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"  ><i class="bi bi-cash"></i></a>
														<a href="javascript:void(0)" class="btn bt" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"  ><i class="bi bi-file-earmark-pdf"></i></a>
											<a href="javascript:void(0)" class="btn bt" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" ><i class="bi bi-eye" ></i></a>
											<a href="javascript:void(0)" class="btn bt" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-pencil"></i></a>
												<a href="javascript:void(0)" class="btn bt deletebtn" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" ><i class="bi bi-trash"></i></a>
											</div>
											</td>
