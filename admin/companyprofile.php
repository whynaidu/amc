...
<body>
  ...
  <!-- <li class="nav-item" role="presentation">
    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Company Settings</button>
  </li> -->
  <li class="nav-item mx-1" role="presentation">
    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#details" type="button" role="tab" aria-controls="profile" aria-selected="false">Details</button>
  </li>
  <li class="nav-item mx-1" role="presentation">
    <button class="nav-link" id="gst-tab" data-bs-toggle="tab" data-bs-target="#gst" type="button" role="tab" aria-controls="contact" aria-selected="false">GST</button>
  </li>
  <li class="nav-item mx-1" role="presentation">
    <button class="nav-link" id="bank-tab" data-bs-toggle="tab" data-bs-target="#bankdetails" type="button" role="tab" aria-controls="bank" aria-selected="false">Bank Details</button>
  </li>
  <li class="nav-item mx-1" role="presentation">
  ...
  <!-- <li class="nav-item mx-1" role="presentation">
    <button class="nav-link" id="curncy-tab" data-bs-toggle="tab" data-bs-target="#curncy" type="button" role="tab" aria-controls="curncy" aria-selected="false">Curency</button>
  </li> -->

</ul>
<div class="tab-content col" id="myTabContent" style="margin-left: -65px;">
  <div class="tab-pane fade show active  ll" id="details" role="tabpanel" aria-labelledby="home-tab">
	  <form class="card">
		  <div class="container">
...
<div class="row g-3 align-items-center">
  <div class="col-md-2">
    <label for="inputPassword6" class="col-form-label">Address Line </label>
  </div>
  <div class="col-md-6">
    <input type="text" id="inputPassword6" class="form-control" aria-describedby="passwordHelpInline">
  </div>
...
<button type="submit" class="btn bt col-2">Save</button>
</form>
</div>


  <div class="tab-pane fade  ll " id="gst" role="tabpanel" aria-labelledby="gst-tab">
	  <form class="card">
<div class="row g-3 align-items-center">
  <div class="col-md-2">
    <label for="inputPassword6" class="col-form-label">GST Registration Type</label>
  </div>
  <div class="col-md-6">
    <input type="text" id="inputPassword6" class="form-control" aria-describedby="passwordHelpInline">
  </div>
...
<div class="row g-3 align-items-center">
  <div class="col-md-2">
    <label for="inputPassword6" class="col-form-label">GSTIN </label>
  </div>
  <div class="col-md-6">
    <input type="text" id="inputPassword6" class="form-control" aria-describedby="passwordHelpInline">
  </div>
  ...
  <div class="tab-pane fade  ll " id="bankdetails" role="tabpanel" aria-labelledby="bank-tab">

	<form class="card">
<div class="row g-3 align-items-center">
  <div class="col-md-2my-4 mx-4">
    <label for="inputPassword6" class="col-form-label">Bank Details </label>
  </div>
  <div class="col-md-6" width="200px" heigth="10px" >
    <input type="text" id="inputPassword6"  class="form-control inpu" aria-describedby="passwordHelpInline">
  </div>
  <div class="col-6">
    <span id="passwordHelpInline" class="form-text">
    </span>
	<button type="submit" class="btn bt">Save</button>
  </div>
  </div>
  </form>
  </div>

  <div class="tab-pane fade  ll " id="terms" role="tabpanel" aria-labelledby="terms-tab">

 	   <form class="card">

<div class="row g-3 align-items-center">
  <div class="col-md-2 my-4 mx-4">
    <label for="inputPassword6" class="col-form-label">Terms and Conditions </label>
  </div>
  <div class="col-md-6" width="200px" heigth="10px" >
    <input type="text" id="inputPassword6"  class="form-control inpu" aria-describedby="passwordHelpInline">
  </div>
  ...
  <form class="card mx-3">
<div class="row g-3 align-items-center mx-3 my-4">
  <div class="col-md-2">
    <label for="inputPassword6" class="col-form-label">Logo</label>
  </div>
  <div class="col-md-8">
    <!-- <input type="text" id="inputPassword6" class="form-control" aria-describedby="passwordHelpInline"> -->
	<div class="input-group mb-3">
  <input type="file" class="form-control" id="inputGroupFile01">
  <label class="input-group-text bt " for="inputGroupFile01">Upload</label>
</div>
  </div>
  <div class="col-6">
    <span id="passwordHelpInline" class="form-text">
...
<div class="row g-3 align-items-center mx-3 my-2">
  <div class="col-md-2">
    <label for="inputPassword6" class="col-form-label">Favicon </label>
  </div>
   <div class="col-md-8">
    <!-- <input type="text" id="inputPassword6" class="form-control" aria-describedby="passwordHelpInline"> -->
	<div class="input-group mb-3">
  <input type="file" class="form-control" id="inputGroupFile02">
  <label class="input-group-text bt " for="inputGroupFile02">Upload</label>
</div>
  </div>
  <div class="col-6">
    <span id="passwordHelpInline" class="form-text">
