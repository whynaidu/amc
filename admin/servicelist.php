...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item " role="presentation">
    <button class="nav-link " id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Service List</button>
  </li>
  <li class="nav-item" role="presentation">
    <button class="nav-link mx-3" id="messages-tab" data-bs-toggle="tab" data-bs-target="#messages" type="button" role="tab" aria-controls="messages" aria-selected="false">Add Service </button>
  </li>
</ul>
						...
						<div class="tab-content">
							<div id="All" class="tab-pane active fade show">
								<div class="table-responsive">
                                    <table class="table card-table display dataTablesCard" id="example2">
										<thead>
                                            <tr>
...
"><i class="bi bi-x"></i></button>
                                    ...
                                    <table id="example3" class="table card-table display dataTablesCard">
										...
										<tbody>
											<tr>
												...
												<td><a href="javascript:void(0)" class="btn bt"><i class="bi bi-eye"></i></a></td>
											</tr>
											<tr>
												...
												<td><a href="javascript:void(0)" class="btn bt"></a></td>
											</tr>
											<tr>
  ...
  <div class="mb-3 ">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                        ...
                                        <div class="qw" style="width: 100%; border-radius: 5px;">
                                        <button type="button" class="btn bt kl mx-3">Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
