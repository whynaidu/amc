...
"><i class="bi bi-x"></i></button>
      ...
      <div class="modal-body">
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Natus, ab quaerat nobis tempora veniam repellat temporibus quasi molestias nostrum excepturi aspernatur suscipit error.
      </div>
      <div class="modal-footer">
        <button type="button" class="btn bt" data-bs-dismiss="modal">Close</button>
