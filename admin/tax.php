...
"><i class="bi bi-x"></i></button></div>
      <div class="modal-body">
        <form>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Tax Name</label>
  ...
  <div class="mb-3">
    ...
    <input type="password" class="form-control" id="exampleInputPassword1">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn bt">Add tax</button>
      </div>
    </div>
  </div>
</div>
	...
	<td><a href="javascript:void(0)" class="btn bt" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" ><i class="bi bi-eye" ></i></a></td>												<td><a href="javascript:void(0)" class="btn bt" style="
    margin-left: -78px;
