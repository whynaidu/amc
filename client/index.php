    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.php" class="brand-logo">
                ...
                <!-- <img class="logo-compact" src="/acaraadmin-10/Acara-v1.0-1-January-2021/xhtml/images/logo12.png" alt=""> -->
                <img class="brand-title" src="./images/tectiginis.jpg"  style="width: 255px;  height: 100px;" alt="Tectignis IT Solutions">
            </a>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="" href="purchase.php">
						<i class="bi bi-cash-stack"></i>
					<span class="nav-text">Purchase</span>
					 </a>
                    </li>
                    <li><a class="" href="amc.php">
						<i class="bi bi-shield-minus"></i>
					<span class="nav-text">A M C</span>
					 </a>
                        
                    </li>
                    <li>
							
							<a class="" href="complaint.php">
								<i class="flaticon-381-internet"></i>
							<span class="nav-text">Complaints</span>
					         </a>
                        
                    </li>
                    <li><a class="" href="services.php" aria-expanded="false"> 
        ...
        ***********************************-->
        <div class="content-body">
			<div class="container">
				<div class="row">
				<div class="col-sm analytics">
					<i class="bi bi-people-fill"></i><br/>Your Complaints
				</div>
				<div class="col-sm analytics">
					<i class="bi bi-person-fill"></i><br/>Open Conplaints
				</div>
				<div class="col-sm analytics">
					<i class="bi bi-file-earmark-break-fill"></i><br/>Progress Complaints
				</div>
				<div class="col-sm analytics">
					<i class="bi bi-headset"></i><br/>Close Complaints
				</div>
				<div class="col-sm analytics">
					<i class="bi bi-shield-minus"></i><br/>A M C
				</div>
				<div class="col-sm analytics">
					<i class="bi bi-tools"></i><br/>Escalate Complaints
				</div>
				</div>
			</div>
            <!-- row -->
