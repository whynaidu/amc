        ...
        <div class="nav-header">
            <a href="index.php" class="brand-logo">
                ...
                <img class="logo-compact" src="./images/logo-text.png" alt="">
                    <img class="brand-title" src="/acaraadmin-10/Acara-v1.0-1-January-2021/1637733681043_TM LOGO.jpg"  style="width: 255px;  height: 100px;" alt="Tectignis IT Solutions">
            </a>
          ...
          <div class="deznav">
            <div class="deznav-scroll">
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="ai-icon" href="employ.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Employee</span>
						</a>
                      
                    </li>
         <li><a class="ai-icon" href="event.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">clietns </span>
						</a>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="table-bootstrap-basic.php">Sales</a></li>
                            <li><a href="table-datatable-basic.php">Complaint List</a></li>
                        </ul>
                    </li>
